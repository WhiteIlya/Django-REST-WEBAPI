...
class EcommerceTestCase(APITestCase):
    ...
    def setUp(self):
        ...
        # We pass the token in all calls in the Header to the API, otherwise failure
    ...
    def test_order_is_more_than_stock(self):
        ...
        for i in self.items:
            ...
            # Check stock of the item with higher quantity => False
    ...
    def test_order_equals_stock(self):
        ...
        for i in self.items:
            current_stock = i.stock
            # Check stock of the item exact quantity => True
